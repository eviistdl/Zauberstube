...
var RezeptArray = [
    ...
    "HERZLICHEN GLÜCKWUNSCH! Du hast deine Ausbildung und der Zauberstube abgeschlossen!"
  ];
...
// Funktion um Buttons unsichtbar zu machen (Wenn das Spiel bestanden wurde)
function hideButtons() {
    var buttons = document.querySelectorAll(".Auswahl");
